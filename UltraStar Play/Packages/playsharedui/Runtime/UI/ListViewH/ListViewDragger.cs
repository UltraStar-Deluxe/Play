...
public class ListViewDragger : DragEventsProcessor
  {
    ...
    {
      if (this.dragAndDropController == null || !this.targetScrollView.contentContainer.worldBound.Contains(pointerPosition))
        return false;
      ...
      if (recycledItem != null)
        num = this.dragAndDropController.CanStartDrag((IEnumerable<int>) new int[1]
        {
          recycledItem.index
        }) ? 1 : 0;
      else
    ...
    protected internal override StartDragArgs StartDrag(Vector3 pointerPosition)
    {
      ...
      return this.dragAndDropController.SetupDragAndDrop((IEnumerable<int>) new int[1]
      {
        recycledItem.index
      });
    }
      ...
      ref ListViewDragger.DragPosition dragPosition)
    {
      ...
      return !this.TryGetDragPosition((Vector2) pointerPosition, ref dragPosition) ? DragVisualMode.Rejected : this.dragAndDropController.HandleDragAndDrop((IListDragAndDropArgs) this.MakeDragAndDropArgs(dragPosition));
    }
    ...
    protected void ApplyDragAndDropUI(ListViewDragger.DragPosition dragPosition)
    {
      ...
      if (this.m_DragHoverBar == null)
      {
        ...
        this.targetListView.RegisterCallback<GeometryChangedEvent>((EventCallback<GeometryChangedEvent>) (e => this.m_DragHoverBar.style.width = (StyleLength) this.targetListView.localBound.width));
      ...
      switch (dragPosition.dragAndDropPosition)
      {
        ...
        case DragAndDropPosition.BetweenItems:
          ...
          this.PlaceHoverBarAtElement((this.targetListView.GetRecycledItemFromIndex(dragPosition.insertAtIndex - 1) ?? this.targetListView.GetRecycledItemFromIndex(dragPosition.insertAtIndex)).rootElement);
          break;
        case DragAndDropPosition.OutsideItems:
          ...
          break;
        default:
          throw new ArgumentOutOfRangeException("dragAndDropPosition", (object) dragPosition.dragAndDropPosition, "Unsupported dragAndDropPosition value");
      }
    }
    ...
    public struct DragPosition : IEquatable<ListViewDragger.DragPosition>
    {
      ...
      public bool Equals(ListViewDragger.DragPosition other) => this.insertAtIndex == other.insertAtIndex && object.Equals((object) this.recycledItem, (object) other.recycledItem) && this.dragAndDropPosition == other.dragAndDropPosition;

      public override bool Equals(object obj) => obj is ListViewDragger.DragPosition other && this.Equals(other);

      public override int GetHashCode() => (int) ((DragAndDropPosition) ((this.insertAtIndex * 397 ^ (this.recycledItem != null ? this.recycledItem.GetHashCode() : 0)) * 397) ^ this.dragAndDropPosition);
    }
  }
