...
public class MaterialIcon : Label
{
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
        {
            ...
            {
                if (TryGetCodepointByIconName(target.icon, out string codepoint))
                {
                    target.AddToClassList("materialSymbol");
    ...
    private static bool TryGetCodepointByIconName(string iconName, out string codepoint)
    {
        // Lazy load mapping
            ...
            || iconNameToCodepoint.Count == 0)
        {
            ...
            codepointLines.ForEach(codepointLine =>
            {
                ...
                {
                    string iconName = iconNameAndCodepoint[0];
                    string codepoint = iconNameAndCodepoint[1];
                    iconNameToCodepoint[iconName] = codepoint;
                }
            });
        }

        if (iconNameToCodepoint.TryGetValue(iconName, out string foundCodepoint))
        {
            codepoint = foundCodepoint;
            return true;
        }
    ...
    // TODO: How to load a TextAsset here?
