// https://github.com/jehugaleahsa/truncon.collections.OrderedDictionary/blob/master/Truncon.Collections/OrderedDictionary.cs
...
namespace Truncon.Collections
{
    ...
    public sealed class InsertionOrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IList<KeyValuePair<TKey, TValue>>
    {
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            if (arrayIndex < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(arrayIndex), arrayIndex, "IndexOutOfRange");
            }
