...
{
    private static readonly string folderPath = $"{Application.dataPath}/Tests/EditModeTests/DirectoryScannerTest/";
    ...
    {
        List<string> folders = DirectoryScanner.GetFolders(folderPath.Replace("/", "//"),
            new DirectoryScannerConfig() { ExcludeHiddenFolders = true, Recursive = true });
        Assert.AreEqual(4, folders.Count);
    }
