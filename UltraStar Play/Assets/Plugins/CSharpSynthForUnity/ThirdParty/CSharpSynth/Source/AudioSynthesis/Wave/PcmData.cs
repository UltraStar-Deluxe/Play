...
namespace AudioSynthesis.Wave
{
    public abstract class PcmData
    {
		...
		protected PcmData(int bits, byte[] pcmData)
        {
            bytes = (byte)(bits / 8);
        ...
        public static PcmData Create(int bits, byte[] pcmData)
        {
            switch (bits)
            {
                case 8:
                    return new PcmData8Bit(bits,pcmData);
                case 16:
                    return new PcmData16Bit(bits, pcmData);
                case 24:
                    return new PcmData24Bit(bits,pcmData);
                case 32:
                    return new PcmData32Bit(bits,pcmData);
                default:
    ...
    {
        public PcmData8Bit(int bits, byte[] pcmData) : base(bits, pcmData) { }
    ...
    {
        public PcmData16Bit(int bits, byte[] pcmData) : base(bits, pcmData) { }
        public override float this[int index]
        {
    ...
    {
        public PcmData24Bit(int bits, byte[] pcmData) : base(bits, pcmData) { }
        public override float this[int index]
        {
    ...
    {
        public PcmData32Bit(int bits, byte[] pcmData) : base(bits, pcmData) { }
        public override float this[int index]
        {
