...
namespace CommonOnlineMultiplayer
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        private GameObject CreateInstance(GameObject prefab) => Instantiate(prefab);
        ...
        public void ClearPool()
        {
            foreach (var prefab in prefabs)
                NetworkManager.Singleton.PrefabHandler.RemoveHandler(prefab); // Unregister Netcode Spawn handlers
