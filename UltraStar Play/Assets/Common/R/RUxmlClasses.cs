...
public static partial class R
{
    public static class UxmlClasses
    {
        ...
        public const string dialogTextButtonDotted = ".dialogTextButton";
        public const string dialogTextButton = "dialogTextButton";
        public const string dialogTitleDotted = ".dialogTitle";
        ...
        public const string titleImageDotted = ".titleImage";
