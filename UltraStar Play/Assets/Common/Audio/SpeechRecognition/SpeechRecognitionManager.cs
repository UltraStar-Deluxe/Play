...
public class SpeechRecognitionManager : MonoBehaviour, INeedInjection
{
    ...
    public Job<SpeechRecognitionResult> ProcessSongMetaJob(float[] monoSamples,
        int startIndex,
        int endIndex,
        int sampleRate,
        SpeechRecognizer speechRecognizer)
    {
        ...
        job.SetAwaitable(() => ProcessSongMetaAsync(monoSamples, startIndex, endIndex, sampleRate, job.Progress, speechRecognizer));
