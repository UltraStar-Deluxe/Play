...
public class Settings
{
    ...
    private static List<PlayerProfile> CreateDefaultPlayerProfiles()
    {
        ...
        result.Add(new PlayerProfile("Player01", "Mikrofon (2- USB Microphone)", Difficulty.Medium, Color.cyan));
        result.Add(new PlayerProfile("Player02", "", Difficulty.Easy, Color.magenta));
        return result;
    }
}