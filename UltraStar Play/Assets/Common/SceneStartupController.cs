...
{
    private static SceneStartupController Instance {
        get {
            var sceneStartupController = GameObject.FindGameObjectWithTag("SceneStartupController");
            if(sceneStartupController) {
                return sceneStartupController.GetComponent<SceneStartupController>();
            } else {
