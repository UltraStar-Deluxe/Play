...
public class FinishOnAdvanceOfPointsReachedGameRoundModifier : GameRoundModifier
{
    public override double DisplayOrder => 10;
    ...
    {
        FinishOnAdvanceOfPointsReachedGameRoundModifierControl modifierControl = GameObjectUtils
            .CreateGameObjectWithComponent<FinishOnAdvanceOfPointsReachedGameRoundModifierControl>();
