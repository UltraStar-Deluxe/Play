...
public class SongSelectEntryControl : INeedInjection, IInjectionFinishedListener, IDisposable
{
    ...
    private async void UpdateSongCover(SongSelectSongEntry songEntry)
    {
        ...
        try
        {
            ...
            {
                SongCoverImageManager.SetDefaultCoverImageAndColor(songMeta, songImageOuter, songImageInner);
                return;
            }
            ...
            SongCoverImageManager.SetCoverOrBackgroundImageFromSpriteAsync(sprite, songImageOuter, songImageInner);
        }
        catch (Exception ex)
        {
    ...
    {
        SongCoverImageManager.SetDefaultCoverImage(songImageOuter, songImageInner);
        if (SongSelectEntry is SongSelectSongEntry songEntry)
        {
            SongCoverImageManager.SetDefaultCoverColor(songEntry.SongMeta, songImageOuter, songImageInner);
        }
        else
        {
    ...
    {
        favoriteIcon.SetVisibleByDisplay(PlaylistUtils.IsFavorite(playlistManager, songEntry.SongMeta));
